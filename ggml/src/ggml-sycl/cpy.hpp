...
inline void cpy_blck_f32_q4_0(const char * cxi, char * cdsti) {
    ...
    for (int j = 0; j < QK4_0 / 2; ++j) {
        ...
        const uint8_t xi0 = std::min<uint8_t>(15, static_cast<uint8_t>(x0 + 8.5f));
        const uint8_t xi1 = std::min<uint8_t>(15, static_cast<uint8_t>(x1 + 8.5f));
...
inline void cpy_blck_f32_q4_1(const char * cxi, char * cdsti) {
    ...
    for (int j = 0; j < QK4_1 / 2; ++j) {
        ...
        const uint8_t xi0 = std::min<uint8_t>(15, static_cast<uint8_t>(x0 + 0.5f));
        const uint8_t xi1 = std::min<uint8_t>(15, static_cast<uint8_t>(x1 + 0.5f));
...
inline void cpy_blck_f32_q5_0(const char * cxi, char * cdsti) {
    ...
    for (int j = 0; j < QK5_0 / 2; ++j) {
        ...
        const uint8_t xi0 = std::min<uint8_t>(31, static_cast<uint8_t>(x0 + 16.5f));
        const uint8_t xi1 = std::min<uint8_t>(31, static_cast<uint8_t>(x1 + 16.5f));
