...
UNITTEST_COMMANDS=(
    ...
    ["b60"]="source /opt/intel/oneapi/setvars.sh && ./build/bin/test-backend-ops -b SYCL3"
)
...
BENCHMARK_COMMANDS=(
    ...
    ["b60"]="source /opt/intel/oneapi/setvars.sh && ./build/bin/test-backend-ops perf -b SYCL3"
)
