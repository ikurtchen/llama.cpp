# CUDA Kernel Categorization for llama.cpp SYCL Backend

Based on `kernel_spec.json` (121 CUDA kernels total).
...
| Matrix Multiplication | k_compute_batched_ptrs, mul_mat_f, mul_mat_f_ids, mm_ids_helper, mul_mat_q, mul_mat_q_stream_k_fixup, mul_mat_vec_f, mul_mat_vec_q | 8 |
| Flash Attention | flash_attn_mask_to_KV_max, flash_attn_stream_k_fixup, flash_attn_combine_results, flash_attn_ext_f16 (mma), flash_attn_tile, flash_attn_ext_vec, flash_attn_ext_f16 (wmma) | 7 |
